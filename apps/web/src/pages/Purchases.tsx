            ...
            <div className="relative w-full max-w-5xl rounded-2xl border border-slate-800 bg-slate-900 shadow-2xl my-4">
                ...
                <div className="flex items-center justify-between border-b border-slate-800 px-6 py-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-white">New Purchase Bill</h2>
                ...
                <div className="p-6 space-y-5">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-between">
                        ...
                        <div className="min-w-[240px] space-y-1.5 rounded-xl border border-slate-800 bg-slate-950/40 p-4">
                            ...
                            <div className="flex justify-between text-sm text-slate-400"><span>VAT {vatRate}%:</span><span className="font-bold text-blue-400">{formatNPR(vatAmount)}</span></div>
                    ...
                    <div className="flex justify-end gap-3 border-t border-slate-800 pt-4">
                        ...
                        <button onClick={handleSave} disabled={saving}
                            className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold transition-colors disabled:opacity-50">
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-3xl font-extrabold tracking-tight text-white font-outfit">Purchase Bills</h1>
                    <p className="text-sm text-slate-400">Stock IN — bills from vendors. Inventory updated automatically.</p>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <button onClick={() => setShowForm(true)}
                        className="flex items-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-500 px-4 py-2.5 text-sm font-bold text-white transition-colors">
            ...
            <div className="relative">
                ...
                <input
                    className="block w-full rounded-xl border border-slate-800 bg-slate-950/80 py-3 pl-10 pr-4 text-white placeholder-slate-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 focus:outline-none"
            ...
            {loading ? (
                ...
                <div className="flex flex-col items-center justify-center p-16 text-center rounded-2xl border border-slate-800 bg-slate-900/20">
                    ...
                    <h3 className="text-lg font-bold text-slate-400">No purchase bills yet</h3>
                        ...
                        <tbody>
                            {filtered.map(bill => (
                                <tr key={bill.id} className="border-b border-slate-800/40 hover:bg-slate-800/20 transition-colors">
                                    ...
                                    <td className="px-4 py-3 text-slate-300">{formatDate(bill.bill_date)}</td>
                                    <td className="px-4 py-3 text-slate-100 max-w-[180px] truncate">{bill.vendor_name || bill.parties?.Parties_name || '—'}</td>
                                    <td className="px-4 py-3 text-center text-slate-400">{bill.purchase_bill_items?.length ?? 0}</td>
                                    <td className="px-4 py-3 text-right text-slate-300">{formatNPR(bill.subtotal)}</td>
                                    <td className="px-4 py-3 text-right text-blue-400">{formatNPR(bill.vat_amount)}</td>
                                    <td className="px-4 py-3 text-right font-bold text-white">{formatNPR(bill.net_total)}</td>
